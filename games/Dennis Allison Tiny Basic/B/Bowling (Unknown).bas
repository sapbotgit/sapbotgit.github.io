...
810 INPUT Z$
900 IF Z$(1,1)="Y" OR Z$(1,1)="y" THEN 990 
960 IF Z$(1,1)="N" OR Z$(1,1)="n" THEN 1530
970 GOTO 720
...
2700 INPUT N$
2710 IF N$="END" OR N$="end" THEN END
2790 K=0: D=0
2880 FOR I=1 TO 20
...
3870 FOR J=1 TO 4-I
3960 K=K+1
4050 IF C(K)=1 THEN PRINT "O "; ELSE  PRINT "+ ";
4410 NEXT J
4500 NEXT I
4590 PRINT ""
...
8550 INPUT A$
8640 IF A$(1,1)="Y"  OR A$(1,1)="y" THEN 2610
8730 END
