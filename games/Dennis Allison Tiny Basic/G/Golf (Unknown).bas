...
330 IF L(0+1)<1 THEN 1150
340 X=0
350 IF L(0+1)>5 THEN 1190
360 PRINT "SHOT WENT ";D1;" YARDS.  IT'S  ";D2;" YARDS FROM THE CUP."
362 PRINT "BALL IS ";INT(O);" YARDS OFF LINE... IN ";
380 GOSUB 400
390 GOTO 620
400 IF L(X+1)=1 THEN 480
410 IF L(X+1)=2 THEN 500
420 IF L(X+1)=3 THEN 520
430 IF L(X+1)=4 THEN 540
440 IF L(X+1)=5 THEN 560
450 IF L(X+1)=6 THEN 580
...
840 D2=INT(SQR(POW(O,2)+POW(ABS(D-D1),2)))
...
1570 D2=-D2
1580 GOTO 1505
1590 READ D: READ P: READ L(1+1): READ L(2+1)
1595 PRINT
